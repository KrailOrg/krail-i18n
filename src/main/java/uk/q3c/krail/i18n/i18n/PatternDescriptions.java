...
/**
 * The base for the resource bundle of {@link PatternDescriptions}. The separation between them is arbitrary, but helps break
 ...
 */
public class PatternDescriptions extends EnumResourceBundle<PatternDescriptionKey> {

    public PatternDescriptions() {
        super();
    }
