...
public class DefaultPatternSource implements PatternSource<LoadingCache<PatternCacheKey, String>> {
     ...
     *
     * @param key    the I18NKey to identify the pattern
     * @param locale the locale for the translation - note that this is not checked to be a supported locale
     * @param <E>    an Enum implementing I18NKey
