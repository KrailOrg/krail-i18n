...
public class DefaultPatternCacheLoader extends CacheLoader<PatternCacheKey, String> implements PatternCacheLoader, OptionContext {
    public static final OptionKey<Boolean> optionKeyAutoStub = new OptionKey<>(Boolean.FALSE, DefaultPatternSourceProvider.class, PatternLabelKey.Auto_Stub,
            PatternDescriptionKey.Auto_Stub);
    public static final OptionKey<Boolean> optionKeyStubWithKeyName = new OptionKey<>(Boolean.TRUE, DefaultPatternSourceProvider.class, PatternLabelKey.Stub_with_Key_Name, PatternDescriptionKey.Stub_with_Key_Name);
