...
class DefaultPatternSourceTest extends Specification {
    ...
    def "retrieve pattern calls the cacheLoader and places entry in cache "() {
        ...
        given:
        PatternCacheKey key = new PatternCacheKey(TestLabelKey.My_Account, Locale.UK)
        sourceProvider.orderedSources(TestLabelKey.My_Account) >> ImmutableSet.of(ClassPatternSource)
        ...
        patternSource.retrievePattern(TestLabelKey.My_Account, Locale.UK)
    ...
    def "clearCache() empties cache"() {
        given:
        PatternCacheKey key1 = new PatternCacheKey(TestLabelKey.My_Account, Locale.UK)
